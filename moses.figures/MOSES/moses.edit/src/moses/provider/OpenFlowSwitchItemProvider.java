...
/**
 * This is the item provider adapter for a {@link moses.OpenFlowSwitch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OpenFlowSwitchItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__TABLE_SPACE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__SWITCH_IS_OPEN_FLOW,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__REQUIRED_HEADERS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__SUPPORTED_PROTOCOLS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__OPTIONAL_HEADERS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.OPEN_FLOW_SWITCH__AVAILABLE_TABLE_SPACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OpenFlowSwitch.class)) {
			case MosesPackage.OPEN_FLOW_SWITCH__TABLE_SPACE:
			case MosesPackage.OPEN_FLOW_SWITCH__REQUIRED_HEADERS:
			case MosesPackage.OPEN_FLOW_SWITCH__VERSION:
			case MosesPackage.OPEN_FLOW_SWITCH__SUPPORTED_PROTOCOLS:
			case MosesPackage.OPEN_FLOW_SWITCH__OPTIONAL_HEADERS:
			case MosesPackage.OPEN_FLOW_SWITCH__AVAILABLE_TABLE_SPACE:
