...
/**
 * This is the item provider adapter for a {@link moses.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_ip_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_ip_feature", "_UI_Group_type"),
				 MosesPackage.Literals.GROUP__IP,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MosesPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MosesPackage.Literals.GROUP__HOSTS_GROUP);
			childrenFeatures.add(MosesPackage.Literals.GROUP__SWITCHES_GROUP);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Group.class)) {
			case MosesPackage.GROUP__IP:
			case MosesPackage.GROUP__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MosesPackage.GROUP__HOSTS_GROUP:
			case MosesPackage.GROUP__SWITCHES_GROUP:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MosesPackage.Literals.GROUP__HOSTS_GROUP,
				 MosesFactory.eINSTANCE.createHost()));

		newChildDescriptors.add
			(createChildParameter
				(MosesPackage.Literals.GROUP__SWITCHES_GROUP,
