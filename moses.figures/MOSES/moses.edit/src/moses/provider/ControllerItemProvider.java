...
/**
 * This is the item provider adapter for a {@link moses.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerItemProvider extends NetworkNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_type_feature", "_UI_Controller_type"),
				 MosesPackage.Literals.CONTROLLER__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Controller.class)) {
			case MosesPackage.CONTROLLER__TYPE:
