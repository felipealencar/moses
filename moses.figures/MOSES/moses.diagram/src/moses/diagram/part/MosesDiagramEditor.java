 ...
 * @generated
 */
public class MosesDiagramEditor extends DiagramDocumentEditor {

	/**
	* @generated
	*/
	public static final String ID = "moses.diagram.part.MosesDiagramEditorID"; //$NON-NLS-1$

	/**
	* @generated
	*/
	public static final String CONTEXT_ID = "moses.diagram.ui.diagramContext"; //$NON-NLS-1$
	...
	*/
	protected PaletteRoot createPaletteRoot(PaletteRoot existingPaletteRoot) {
		...
		new MosesPaletteFactory().fillPalette(root);
		return root;
	}
	...
	*/
	protected PreferencesHint getPreferencesHint() {
		return MosesDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT;
	}
	...
	*/
	public String getContributorId() {
		return MosesDiagramEditorPlugin.ID;
	}
	...
	*/
	protected IDocumentProvider getDocumentProvider(IEditorInput input) {
		if (input instanceof URIEditorInput) {
			return MosesDiagramEditorPlugin.getInstance().getDocumentProvider();
		}
	...
	*/
	protected void setDocumentProvider(IEditorInput input) {
		if (input instanceof URIEditorInput) {
			setDocumentProvider(MosesDiagramEditorPlugin.getInstance().getDocumentProvider());
		} else {
