 ...
 * @generated
 */
public class TrafficOperatorUnitValueEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.TrafficOperatorUnitValueEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TrafficOperatorUnitValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Traffic_2007, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.TrafficOperatorUnitValueEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TrafficLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TrafficLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TrafficLabelFigure() {
			this.setText("Traffic");
		}
