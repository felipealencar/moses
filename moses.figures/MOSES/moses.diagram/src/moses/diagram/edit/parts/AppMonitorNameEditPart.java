 ...
 * @generated
 */
public class AppMonitorNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.AppMonitorNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public AppMonitorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.AppMonitor_2004, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.AppMonitorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AppMonitorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AppMonitorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AppMonitorLabelFigure() {
			this.setText("AppMonitor");
		}
