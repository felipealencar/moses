...
public class WrappingLabel5EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.RuleTargetHostRule_4005, getParserElement(),
