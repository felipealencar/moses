 ...
 * @generated
 */
public class ControllerNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.ControllerNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Controller_2001, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.ControllerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ControllerLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ControllerLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ControllerLabelFigure() {
			this.setText("Controller");
		}
