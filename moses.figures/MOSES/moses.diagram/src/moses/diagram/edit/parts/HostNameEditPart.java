 ...
 * @generated
 */
public class HostNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.HostNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public HostNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Host_2002, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.HostNameEditPart.VISUAL_ID));
		}
		return parser;
	}
