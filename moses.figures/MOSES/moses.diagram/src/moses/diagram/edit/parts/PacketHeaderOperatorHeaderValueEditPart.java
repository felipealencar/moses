...
import moses.diagram.edit.policies.MosesTextSelectionEditPolicy;
import moses.diagram.part.MosesVisualIDRegistry;
import moses.diagram.providers.MosesElementTypes;
import moses.diagram.providers.MosesParserProvider;

/**
 * @generated
 */
public class PacketHeaderOperatorHeaderValueEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry
				.getType(moses.diagram.edit.parts.PacketHeaderOperatorHeaderValueEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PacketHeaderOperatorHeaderValueEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MosesTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.PacketHeader_2009, getParserElement(),
					MosesVisualIDRegistry
							.getType(moses.diagram.edit.parts.PacketHeaderOperatorHeaderValueEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MosesEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PacketHeaderLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PacketHeaderLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PacketHeaderLabelFigure() {
			this.setText("PacketHeader");
		}
