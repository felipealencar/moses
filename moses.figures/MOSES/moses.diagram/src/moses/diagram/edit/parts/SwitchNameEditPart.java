...
public class SwitchNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.SwitchNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Switch_2003, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.SwitchNameEditPart.VISUAL_ID));
		}
		return parser;
	}
