...
import moses.diagram.edit.policies.HostHostSwitchItemSemanticEditPolicy;

/**
 * @generated
 */
public class HostHostSwitchEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HostHostSwitchItemSemanticEditPolicy());
	}
