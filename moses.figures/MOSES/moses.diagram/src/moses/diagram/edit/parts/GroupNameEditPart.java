...
public class GroupNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.GroupNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Group_2011, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.GroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
