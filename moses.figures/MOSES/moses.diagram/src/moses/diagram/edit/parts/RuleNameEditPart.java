 ...
 * @generated
 */
public class RuleNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.RuleNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Rule_2005, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.RuleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RuleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RuleLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RuleLabelFigure() {
			this.setText("Rule");
		}
