 ...
 * @generated
 */
public class ConditionConditionEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.ConditionConditionEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConditionConditionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Condition_2006, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.ConditionConditionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, MosesEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConditionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConditionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConditionLabelFigure() {
