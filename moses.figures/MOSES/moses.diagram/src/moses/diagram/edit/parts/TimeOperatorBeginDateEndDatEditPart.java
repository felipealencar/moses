 ...
 * @generated
 */
public class TimeOperatorBeginDateEndDatEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				MosesVisualIDRegistry.getType(moses.diagram.edit.parts.TimeOperatorBeginDateEndDatEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TimeOperatorBeginDateEndDatEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Time_2008, getParserElement(),
					MosesVisualIDRegistry
							.getType(moses.diagram.edit.parts.TimeOperatorBeginDateEndDatEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TimeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TimeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TimeLabelFigure() {
			this.setText("Time");
		}
