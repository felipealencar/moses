 ...
 * @generated
 */
public class AppNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.AppNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public AppNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.App_2010, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.AppNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AppLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AppLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AppLabelFigure() {
			this.setText("App");
		}
