 ...
 * @generated
 */
public class HostName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MosesVisualIDRegistry.getType(moses.diagram.edit.parts.HostName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public HostName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MosesParserProvider.getParser(MosesElementTypes.Host_3001, getParserElement(),
					MosesVisualIDRegistry.getType(moses.diagram.edit.parts.HostName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new HostLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HostLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HostLabelFigure() {
			this.setText("Host");
		}
