...
public class RuleTargetGroupRuleReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RuleTargetGroupRuleReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRuleTargetGroupRule_4007(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRuleTargetGroupRule_4007(getOldSource(),
				getNewTarget());
	}
