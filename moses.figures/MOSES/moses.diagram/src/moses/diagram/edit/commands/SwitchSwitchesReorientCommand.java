...
public class SwitchSwitchesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SwitchSwitchesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistSwitchSwitches_4003(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistSwitchSwitches_4003(getOldSource(),
				getNewTarget());
	}
