...
public class AppAppRuleReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AppAppRuleReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistAppAppRule_4011(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistAppAppRule_4011(getOldSource(),
				getNewTarget());
	}
