 ...
 * @generated
 */
public class ConditionConditionTrafficReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ConditionConditionTrafficReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConditionConditionTraffic_4013(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConditionConditionTraffic_4013(getOldSource(), getNewTarget());
	}
