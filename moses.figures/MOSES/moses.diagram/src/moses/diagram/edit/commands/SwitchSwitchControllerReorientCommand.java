...
public class SwitchSwitchControllerReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SwitchSwitchControllerReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistSwitchSwitchController_4002(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return MosesBaseItemSemanticEditPolicy.getLinkConstraints().canExistSwitchSwitchController_4002(getOldSource(),
				getNewTarget());
	}
