 ...
 * @generated
 */
public class MosesCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public MosesCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put("modelID", SdnEditPart.MODEL_ID); //$NON-NLS-1$
