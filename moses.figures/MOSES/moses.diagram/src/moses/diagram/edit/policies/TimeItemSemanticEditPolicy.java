 ...
 * @generated
 */
public class TimeItemSemanticEditPolicy extends MosesBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TimeItemSemanticEditPolicy() {
		super(MosesElementTypes.Time_2008);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MosesVisualIDRegistry.getVisualID(incomingLink) == ConditionConditionTimeEditPart.VISUAL_ID) {
