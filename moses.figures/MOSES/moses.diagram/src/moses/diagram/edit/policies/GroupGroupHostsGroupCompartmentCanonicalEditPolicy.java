 ...
 * @generated
 */
public class GroupGroupHostsGroupCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return MosesPackage.eINSTANCE.getGroup_HostsGroup();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MosesNodeDescriptor> childDescriptors = MosesDiagramUpdater
				.getGroupGroupHostsGroupCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Host2EditPart.VISUAL_ID == MosesVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MosesNodeDescriptor> childDescriptors = MosesDiagramUpdater
				.getGroupGroupHostsGroupCompartment_7001SemanticChildren((View) getHost().getModel());
