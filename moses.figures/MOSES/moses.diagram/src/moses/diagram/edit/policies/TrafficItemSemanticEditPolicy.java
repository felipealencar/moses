 ...
 * @generated
 */
public class TrafficItemSemanticEditPolicy extends MosesBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TrafficItemSemanticEditPolicy() {
		super(MosesElementTypes.Traffic_2007);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MosesVisualIDRegistry.getVisualID(incomingLink) == ConditionConditionTrafficEditPart.VISUAL_ID) {
