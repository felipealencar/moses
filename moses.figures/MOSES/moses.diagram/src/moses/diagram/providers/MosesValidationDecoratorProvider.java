...
import moses.diagram.part.MosesDiagramEditor;
import moses.diagram.part.MosesDiagramEditorPlugin;
import moses.diagram.part.MosesVisualIDRegistry;
import moses.diagram.part.ValidationMarker;

/**
 * @generated
 */
public class MosesValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MosesDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && SdnEditPart.MODEL_ID.equals(MosesVisualIDRegistry.getModelID(view));
	}
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					MosesDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
				}
			}
		});
	}
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				MosesDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
