...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        if i % 100 == 0 and i != 0:
            ...
            if exploration == 'e-greedy':
                print
                "Mean Reward: " + str(r_mean) + " Total Steps: " + str(total_steps) + " e: " + str(e)
            if exploration == 'boltzmann':
                print
                "Mean Reward: " + str(r_mean) + " Total Steps: " + str(total_steps) + " t: " + str(e)
            if exploration == 'bayesian':
                print
                "Mean Reward: " + str(r_mean) + " Total Steps: " + str(total_steps) + " p: " + str(e)
            if exploration == 'random' or exploration == 'greedy':
                print
                "Mean Reward: " + str(r_mean) + " Total Steps: " + str(total_steps)
